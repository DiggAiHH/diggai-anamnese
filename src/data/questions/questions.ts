/**
 * Core Questions Array
 * 
 * All 270+ main question definitions for the DiggAI Anamnese platform.
 * Question IDs are immutable and must NOT be changed without explicit medical review.
 * 
 * Structure:
 * - Identification & Visit Status (basis)
 * - Enrollment (insurance, address, contact)
 * - Clinical Presentation (complaints, vitals)
 * - Medical History (medical conditions, medications, allergies)
 * - Services (recipes, documents, appointments, messages)
 ...
 * Extended with newQuestions array for total ~296 questions
 */
...
/**
 * Export merged questions array (core + new questions)
 * Maintains backward compatibility with existing imports
 */
export const questions: Question[] = [...coreQuestions, ...newQuestions];

/**
 * Export individual arrays for fine-grained imports
 * Useful for tree-shaking and selective imports
 */
export { coreQuestions };
